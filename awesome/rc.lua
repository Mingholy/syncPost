...
-- User-defined softwares
local browser      = "google-chrome"
local secondary_browser = "firefox"
local wechat = "electronic-wechat"
local neteasemusic = "netease-cloud-music"
local pycharm = "pycharm"


awful.util.terminal = terminal
awful.util.tagnames = { "1-Web", "2-Tmux", "3-Code", "4-Vim", "5-SS", "6-Media", "7-Doc", "8-File", "9-IM"}
...
local myawesomemenu = {
    ...
    { "Config", string.format("%s -e %s %s", terminal, editor, "/home/mingholy-pro/.config/awesome/rc.lua") },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "a", function () awful.spawn(secondary_browser) end),
    awful.key({ modkey }, "F1", function() awful.spawn(file) end),
    awful.key({ modkey }, "F2", function () awful.spawn(wechat) end),
    awful.key({ modkey }, "F3", function () awful.spawn(neteasemusic) end),
    awful.key({ modkey }, "F4", function() awful.spawn(pycharm) end),
...
awful.rules.rules = {
    ...
    { rule = { class = "shadowsocks-qt5" },
      properties = { screen = 1, tag = screen[1].tags[5], minimized = true }  },
    { rule = { class = "netease-cloud-music" },
      properties = { screen = 1, tag = screen[1].tags[6], minimized = true }  },
